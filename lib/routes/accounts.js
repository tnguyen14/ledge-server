...
module.exports = function (server) {
  server.get('/accounts', function (req, res, next) {
    Router.route(req, res, next, accounts.showAll);
  });
  ...
  server.post('/accounts', function (req, res, next) {
    ...
    Router.route(req, res, next, accounts.newAccount);
  });
  ...
  server.patch('/accounts/:name', function (req, res, next) {
    ...
    Router.route(req, res, next, accounts.updateAccount);
  });

  server.del('/accounts/:name', function (req, res, next) {
    Router.route(req, res, next, accounts.deleteAccount);
  });
}